...
namespace GenericRepository.DataAccess.Contexts
{
    public partial class NorthwindContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=MESUT_DELL; Database=Northwind; Trusted_Connection=True;");
            }
            ...
            //    optionsBuilder.UseSqlServer(configuration["ConnectionStrings:NorthwindConnectionString"]);
            //}
        }
